...
use clap::Parser;
use krabink_server::config::Overrides;
use krabink_server::errors::{Error, Result, ResultExt};
use krabink_server::{Config, relay, replica};

#[derive(Debug, clap::Parser)]
#[clap(version, about = "krabink cloud server: relay + replica")]
struct Cli {
