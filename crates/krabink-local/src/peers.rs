...
impl PeerTarget {
    ...
    pub fn from_pair(info: &krabink_core::PairInfo, kind: PeerKind) -> Result<Self, String> {
    ...
    pub fn replica_from_pair(info: &krabink_core::PairInfo) -> Result<Option<Self>, String> {
