//! Core document model for krabink: CRDT-backed markdown notes with embedded
...
//! it compiles unchanged for Linux, macOS and iOS (via `krabink-ffi`).
//!
//! ```
//! use krabink_core::{NoteDoc, NoteId};
//!
//! let id = NoteId::new();
