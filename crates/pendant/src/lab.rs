//! `pendant brush-lab`: replay recorded strokes (the iPad's
//! `-recordStrokes 1` files, `crates/pendant-core/tests/corpus/brush/`)
...
//! (`pendant_core::corpus::StrokeMetrics`). Same core code as the app and
